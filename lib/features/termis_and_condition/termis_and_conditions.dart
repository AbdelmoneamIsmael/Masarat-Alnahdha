      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            18.verticalSpace,
            Text(
              r'''مرحبًا بك في تطبيق مسارات النهضة لتجارة المواد الغذائية. 
نرجو منك قراءة هذه الشروط والأحكام بعناية قبل استخدام التطبيق. 

1- جميع المنتجات المتوفرة يتم اختيارها بعناية لتكون طازجة وآمنة للاستهلاك.  
2- الأسعار المعروضة قابلة للتغيير وفقًا لتوافر المنتجات ومواسمها.  
3- قد تختلف صورة المنتج عن الشكل الفعلي نظرًا لاختلاف الموردين أو طرق العرض.  
4- يلتزم تطبيق مسارات النهضة بتوصيل طلباتك في أسرع وقت ممكن.  
...
14- يلتزم فريق مسارات النهضة بالحفاظ على خصوصية بياناتك وعدم مشاركتها مع أي طرف ثالث.  
